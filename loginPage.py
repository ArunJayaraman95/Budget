...
# Create buttons
forgotButton = Button(loginMenu, text = "Forgot Password", bg = "#A9e451", padx = 10, pady = 0, font = ("Verdana", 10), command = forgotPassword) #code here for new frame
...
homeLogOutButton.grid(row = 7, column = 0, padx = 20, pady = 10, sticky = 'ew')
...
resetMenu.place(height = 600, width = 600, anchor = CENTER, rely = 0.5, relx = 0.5)
# Create labels for resetMenun
resetTitle = Label(resetMenu, text = "Reset Password Code Sent to Email", font = ("Arial Black", 22), bg = accentColor)
resetTitle.grid(row = 0, column = 0, padx = 10, pady = 10, columnspan = 2, sticky = "ew")

enterresetcodeLabel = Label(resetMenu, text = "Enter code: ", font = ("Times New Roman", 14), bg = accentColor)
...
passwordResetLabel = Label(resetMenu, text = "New Password: ", font = ("Times New Roman", 14), bg = accentColor)
passwordResetLabel.grid(row = 3, column = 0, padx = 10, pady = 10, columnspan = 2,sticky = 'w')

passwordResetConLabel = Label(resetMenu, text = "Confirm New Password: ", font = ("Times New Roman", 14), bg = accentColor)
...
#Create buttons
doneResetButton = Button(resetMenu, text = "Done", bg = "#A9E451", padx = 10, pady = 0, font =("Times New Roman", 15), command = processForgotCode)
...
factorMenu.place(height = 500, width = 600, anchor = CENTER, rely = 0.5, relx = 0.5)
# Create labels for Two-Factor Authentication
twoFactorTitle = Label(factorMenu, text = "Two-Factor Authentication", font = ("Algerian", 25), bg = accentColor)
...
# Create input box for Enter code
ecInput = Entry(factorMenu, width = 10, font = inputFont)
ecInput.grid(row = 2, column = 0, padx = 10, pady = 10, columnspan = 2,sticky = 'ew')

#Create buttons
doneButton = Button(factorMenu, text = "Done", bg = "#51e460", padx = 10, pady = 10, font = ("Verdana", 10), command = processUserEnteredCode)
doneButton.grid(row = 3, column = 0, padx = 10, pady = 10, sticky = 'ew')
doneButton.config(height = 2, width = 1)
